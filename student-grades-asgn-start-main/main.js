...
function randomTo100() {
  ...
  let randgrade = Math.floor(Math.random() * randvalue);
...
function countBelow50() {
  ...
  outputEl.innerHTML = out +" "+ "grades are below 50";
...
function lowGradesTo50() {
  ...
  outputEl.innerHTML = out +" "+ "grades below 50 changed to 50";
}
...
function removeGradesBelow50() {
  ...
  outputEl.innerHTML = "grades below 50 removed";
}
